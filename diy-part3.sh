...
sed -i -e '88 s/^/#/' /workdir/openwrt/build_dir/target-aarch64_generic_musl/linux-msm89xx_msm8916/linux-6.1/Makefile

sed -i "88 s/^/HOSTLDLIBS_extract-cert = - lcrypto - lpthread/" /workdir/openwrt/build_dir/target-aarch64_generic_musl/linux-msm89xx_msm8916/linux-6.1/Makefile
